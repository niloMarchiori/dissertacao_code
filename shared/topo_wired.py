...
class Client(ClientNode):
    def __init__(self, *args, **kwargs):
        ...
        # extrai de kwargs['args'] se disponível, senão tenta diretamente de kwargs
        client_args = kwargs.get('args', {})
        self.alpha = client_args.get('alpha') or kwargs.get('alpha')
        self.gamma = client_args.get('gamma') or kwargs.get('gamma')
