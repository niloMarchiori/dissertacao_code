...
class Client_script():
    def __init__(self,broker_addr,client_name,client_id,client_instantiation_args):
        
        self.energy_consumption=0
        self.host_energy_consumption
        self.broker_addr=broker_addr
        self.client_name=client_name
        self.client_id=client_id
        self.client_instantiation_args=client_instantiation_args
        self.selected=False

        self.client_mqtt=mqtt.Client(str(client_name))
        self.client_mqtt.connect(self.broker_addr,keepalive=0)
        self.client_mqtt.on_connect=on_connect

    def add_mqtt_callback(self,endpoint:str,callback:callable):
        self.client_mqtt.message_callback_add(endpoint,callback)
